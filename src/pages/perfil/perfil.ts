...
export class PerfilPage {
    ...
    this._usuarioProvider.getUsuario(this.id).subscribe(
      res=> {
          ...
          if(this.usuario.imagen != null){
            this.rutaImagen = `http://10.14.14.219:3002/profile/${this.usuario.imagen}.png`;
            //this.rutaImagen = `http://10.14.14.219:3002/profile/defecto.png`;
  ...
  agregarFoto(){
    ...
    this.http.post('http://10.14.14.219:3002/api/upload', fd)
      .subscribe(
        res=>{
          console.log(res)
          let data = {
          ...
          this._usuarioProvider.putFotoUsuario(this.id,data)
            .subscribe(
              res=>{
                console.log(res);
                this.rutaImagen = `http://10.14.14.219:3002/profile/${aleatorio}-${this.id}.png`;
              },
              e=>{
                console.log(e);
              }
